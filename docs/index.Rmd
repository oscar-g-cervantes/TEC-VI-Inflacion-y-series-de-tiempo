...
adfTest(Indice_mensual_ts, lags = 1, type = "nc") # Con constante
adfTest(Indice_mensual_ts, lags = 1, type = "c")  # Sin constante ni tendencia
adfTest(Indice_mensual_ts, lags = 1, type = "ct") # Con constante y tendencia
...
```{r}
urppTest(Indice_mensual_ts, type = c("Z-alpha", "Z-tau"), model = c("constant"), doplot = F)
urppTest(Indice_mensual_ts, type = c("Z-alpha", "Z-tau"), model = c("constant", "trend"), doplot = F)
